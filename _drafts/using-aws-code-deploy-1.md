...
<img src="img/2017-04-25_create_service_role_1.png" width="400px">

**AWS Service Role** 섹션에서 스크롤다운하여 **AWS CodeDeploy**를 찾고, `Select` 버튼을 클릭한다.
<img src="img/2017-04-25_create_service_role_2.jpg" width="860px">

**AWSCodeDeployRole**을 선택하고 다음 단계로 넘어간다.
<img src="img/2017-04-25_create_service_role_3.jpg" width="900px">

Service Role 이름을 정하고 마친다. 아래 예에서는 **"MyCodeDeployRole"**이라고 하였다. 내가 의도적으로 만든 것임을 표시하기 위하여 "My" 접두어를 붙였다.
<img src="img/2017-04-25_create_service_role_4.png" width="900px">

생성된 Role을 확인할 수 있다.
<img src="img/2017-04-25_create_service_role_5.png" width="740px">
...
<img src="img/2017-04-25_create_service_role_6.png" width="880px">
...
<img src="./img/2017-04-25_create_instance_profile_1.png" width="600px">

가장 하단의 **Create Your Own Policy**를 선택한다
<img src="./img/2017-04-25_create_instance_profile_2.png" width="840px">

**Permission Policy Name**에 `MyCodeDeploy-EC2-Permissions`을 입력한다. 
<img src="./img/2017-04-25_create_instance_profile_3.png" width="480px">
...
<img src="./img/2017-04-25_create_instance_profile_4.png" width="700px">

Instance Profile을 성공적으로 생성하였다.
<img src="./img/2017-04-25_create_instance_profile_5.png" width="630px">
...
<img src="./img/2017-04-25_create_instance_profile_6.png" width="860px">

매우 많은 policy들이 보이는데, 검색란에 "my"를 입력하여 조금 전 내가 만든 `MyCodeDeploy-EC2-Permissions`를 찾고 선택한 후 다음 단계로 이동한다.
<img src="./img/2017-04-25_create_instance_profile_7.png" width="920px">

Role 이름을 **MyCodeDeploy-EC2-Instance-Profile**로 입력하고 `Create role` 버튼을 눌러서 Role 생성 작업을 마친다.
<img src="./img/2017-04-25_create_instance_profile_8.png" width="880px">
